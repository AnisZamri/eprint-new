                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="checkout__form__input">
                                    ...
                                    <input type="text" name="orderName"  id="orderName" aria-describedby="emailHelp" value="Yati" >
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                ...
                                <p><b>Phone Number <span></span></b></p>
                                    <input type="text" name="orderPhone"  id="orderPhone" aria-describedby="emailHelp" value="0173415700">
                            ...
                            <div class="col-lg-12">
                                ...
                                <input type="text" name="orderAddress"  id="orderAddress" aria-describedby="emailHelp" value="Batu 2, Jalan Ipoh">
